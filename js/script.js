                ...
                if (onepressFollowByEmailText7 != undefined) {
                    for (var onepressAuthorImage = 0, onepressMoreLink7 = onepressFollowByEmailText7; onepressAuthorImage < onepressMoreLink7.length; onepressAuthorImage++) {
                        ...
                        case 'featured':
                            ...
                            case 0:
                                onepressFollowByEmailTextb += '<article class="featured-item post item-' + onepressAuthorImage + '"><div class="featured-item-inner"><a class="entry-image-link before-mask" href="' + onepressMoreLink9 + '"><span class="lazyload entry-thumb" data-src="' + onepressFollowByEmailText9 + '"/></a>' + onepressFollowByEmailText2 + '<div class="entry-header entry-info"><h2 class="entry-title"><a href="' + onepressMoreLink9 + '">' + onepressFollowByEmailText8 + '</a></h2>' + onepressFollowByEmailTexta[0] + '</div></div></article><div class="featured-scroll">';
                                break;
                            default:
                                onepressFollowByEmailTextb += '<article class="featured-item post item-' + onepressAuthorImage + '"><div class="featured-item-inner"><a class="entry-image-link before-mask" href="' + onepressMoreLink9 + '"><span class="lazyload entry-thumb" data-src="' + onepressFollowByEmailText9 + '"/></a>' + onepressFollowByEmailText2 + '<div class="entry-header entry-info"><h2 class="entry-title"><a href="' + onepressMoreLink9 + '">' + onepressFollowByEmailText8 + '</a></h2>' + onepressFollowByEmailTexta[1] + '</div></div></article>';
                                break
                            };
                            break;
                        case 'related':
                            onepressFollowByEmailTextb += '<article class="related-item post item-' + onepressAuthorImage + '"><div class="entry-image"><a class="entry-image-link" href="' + onepressMoreLink9 + '"><span class="lazyload entry-thumb" data-src="' + onepressFollowByEmailText9 + '"/></a></div><div class="entry-header"><h2 class="entry-title"><a href="' + onepressMoreLink9 + '">' + onepressFollowByEmailText8 + '</a></h2>' + onepressFollowByEmailTexta[1] + '</div></article>';
                            break
                        };
